      ...
      <div className="game-tutorial-content">
        <div className="tutorial-horizontal-layout">
          ...
          <div className="tutorial-column-1">
            ...
            <span className={`ai-defect-desc ${highlightedDesc.includes("ai-defect-desc") ? 'highlight' : ''}`}>AI DEFECT</span>
          ...
          <div className="tutorial-column-2">
            ...
            <span className={`ai-cooperate-desc ${highlightedDesc.includes("ai-cooperate-desc") ? 'highlight' : ''}`}>AI COOPERATE</span>
          ...
          <div className="tutorial-column-3">
            ...
            <span className={`user-cooperate-desc ${highlightedDesc.includes("user-cooperate-desc") ? 'highlight' : ''}`}>YOU COOPERATE</span>
          ...
          <div className="tutorial-column-4">
            ...
            <span className={`user-cooperate-desc ${highlightedDesc.includes("user-defect-desc") ? 'highlight' : ''}`}>YOU DEFECT</span>
        ...
        <div className="tutorial-action">
          ...
          {isComplete && (
            <button
              ...
              onClick={() => navigate('/chatbot-tutorial')}
            >
              Proceed
            </button>
          )}
