  ...
  return (
    <div className="container tutorial-container">
      ...
      <h2 className="tutorial-subtitle">
        Learn about your job at Caboodle, a job based on sharing and withholding investment data. {/* <Typewriter text="Learn about your job at Caboodle, a job based on sharing and withholding investment data." speed={30} delay={2000}/> */}
      </h2>
